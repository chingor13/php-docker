...
ZEND_BEGIN_ARG_INFO(StackdriverTraceContext_construct_arginfo, 0)
	ZEND_ARG_ARRAY_INFO(0, contextOptions, 0)
ZEND_END_ARG_INFO();

/* {{{ proto Stackdriver\Trace\Context::__construct(array $contextOptions) }}} */
...
/* {{{ proto Stackdriver\Trace\Context::spanId() }}} */
...
/* {{{ proto Stackdriver\Trace\Context::traceId() }}} */
...
static zend_function_entry stackdriver_trace_context_methods[] = {
    PHP_ME(StackdriverTraceContext, __construct, StackdriverTraceContext_construct_arginfo, ZEND_ACC_PUBLIC | ZEND_ACC_CTOR)
